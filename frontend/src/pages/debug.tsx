  ...
  setup() {
    ...
    const onCreateGoal = () =>
      apiStore.createGoal({
        ...
        target_hours_per_week: createGoalHoursPerWeek.value ? Number(createGoalHoursPerWeek.value) : null,
      })
      ...
      <section class={s.apiSection}>
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (getUserId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="user_id"
          />
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (createUserEmail.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="email"
            placeholder="email"
          />
          <input
            ...
            onInput={(e: Event) => (createUserTimezone.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="timezone (UTC)"
          />
          <input
            value={createUserWorkStart.value}
            onInput={(e: Event) => (createUserWorkStart.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="number"
            min="0"
            max="23"
          ...
          <input
            ...
            onInput={(e: Event) => (createUserWorkEnd.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="number"
            min="0"
            max="23"
          ...
          <input
            ...
            onInput={(e: Event) => (createUserMinSleep.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="number"
            min="4"
            max="12"
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (listTasksGoalId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (getTaskId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="task_id"
          />
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (createTaskName.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="name"
          />
          <input
            value={createTaskHours.value}
            onInput={(e: Event) => (createTaskHours.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="number"
          ...
          <input
            ...
            onInput={(e: Event) => (createTaskDeadline.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="deadline"
          />
          <input
            value={createTaskGoalId.value}
            onInput={(e: Event) => (createTaskGoalId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="goal_id"
          />
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (listGoalsUserId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="user_id"
          />
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (getGoalId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="goal_id"
          />
        ...
        <div class={s.block}>
          ...
          <input
            ...
            onInput={(e: Event) => (createGoalName.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="name"
          />
          <select
            value={createGoalType.value}
            onChange={(e: Event) => (createGoalType.value = (e.target as HTMLSelectElement).value as GoalType)}
            class={s.input}
          >
          ...
          <input
            ...
            onInput={(e: Event) => (createGoalPriority.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="number"
            min="1"
            max="5"
          ...
          <input
            ...
            onInput={(e: Event) => (createGoalUserId.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="user_id"
          />
          <input
            value={createGoalDeadline.value}
            onInput={(e: Event) => (createGoalDeadline.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            placeholder="deadline"
          />
          <input
            value={createGoalHoursPerWeek.value}
            onInput={(e: Event) => (createGoalHoursPerWeek.value = (e.target as HTMLInputElement).value)}
            class={s.input}
            type="number"
